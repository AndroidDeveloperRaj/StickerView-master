...
public class StickerView extends FrameLayout {
  ...
  public void configDefaultIcons() {
    ...
    BitmapStickerIcon editIcon = new BitmapStickerIcon(
            ContextCompat.getDrawable(getContext(), R.drawable.sticker_ic_mode_edit_white_24dp),
            BitmapStickerIcon.LEFT_BOTTOM);
    editIcon.setIconEvent(new MainActivity.HelloIconEvent());
    icons.clear();
  ...
  GestureDetector gestureDetector = new GestureDetector(MainActivity.context, new GestureDetector.SimpleOnGestureListener() {
    @Override
